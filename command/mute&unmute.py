...
class Mute(commands.Cog):
    ...
    async def mute(self, ctx, member: discord.Member, time='___', reason='___'):
        guild = ctx.guild
        mutedRole = discord.utils.get(guild.roles, id=roles.tunhan)
        ...
        if time == '___':
            ...
            channel = self.client.get_channel(channels.mutechannel)
